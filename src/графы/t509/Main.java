...
/**
 * Задача 509
 * Вывести количество переходов фишки
 */
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        out.println(new Solver(start, end).solve());
    }
...
class Solver {
    ...
    public int solve() {
        ...
        while(!queue.isEmpty()) {
            ...
            int hashPos = cur.indexOf('#');
            for(String var: generate(cur, hashPos)) {
                if (var.equals(end)) {
                    return times + 1;
                }
    ...
    private LinkedList<String> generate(String s, int pos) {
        LinkedList<String> vars = new LinkedList<>();

        for (int move: moves[pos]) {
            StringBuilder sb = new StringBuilder(s);
            sb.setCharAt(pos, sb.charAt(move));
            sb.setCharAt(move, '#');
