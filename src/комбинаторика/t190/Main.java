...
/**
 * Задача 190
 * Вывести номер перестановки по перестановке
 * N до 12, K до 12
 */
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int n = in.nextInt();
        int k = in.nextInt();
        int[] perm = in.nextInts(k);

        System.out.println(solve(n, k, perm));
    }

    static long solve(int n, int k, int[] perm) {
        long num = 1;
        ...
        for (int p : perm) {
            num += A(n, k) * nums.indexOf(p);
            nums.removeFirstOccurrence(p);
            n--;
            k--;
        }
