...
/**
 * Задача 653
 * Переставить матрицу в изначальное положение
 * N, M до 250
 */
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        sort(col, 'R', actions);
        sort(matx[0], 'C', actions);

        out.println(actions.size());
        actions.forEach(out::println);
    }

    static void sort(int[] arr, char mod, LinkedList<String> actions) {
